...
export const metadata: Metadata = {
  title: "AutoDeal - Premium Cars & Expert Service",
  description: "Find your perfect car with AutoDeal. Browse quality vehicles, get competitive financing, and experience stress-free car buying from trusted dealers.",
  keywords: "cars for sale, auto dealer, car financing, used cars, luxury vehicles, car buying",
  metadataBase: new URL("https://autodeal.com"),
  alternates: {
    canonical: "https://autodeal.com"
  },
  openGraph: {
    title: "AutoDeal - Premium Cars & Expert Service",
    description: "Find your perfect car with quality guarantee and expert service",
    siteName: "AutoDeal",
    type: "website",
    images: [
      {
        url: "https://images.pexels.com/photos/120049/pexels-photo-120049.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "AutoDeal premium car showroom"
      }
    ]
  },
  twitter: {
